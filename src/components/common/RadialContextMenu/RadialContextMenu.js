...
export default {
  ...
  created() {
    this.radius = 50;
    this.innerRadius = this.radius * 0.504;
    this.sectorSpace = this.radius * 0;
  },
  mounted() {
  ...
  methods: {
    ...
    $_createSector(startAngleDeg, endAngleDeg, scale, item) {
      let info = {};
    ...
    $_getSectorPathCmd(startAngleDeg, endAngleDeg, scale) {
    ...
    $_getSectorCenter(startAngleDeg, endAngleDeg) {
